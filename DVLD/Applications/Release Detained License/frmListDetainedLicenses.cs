...
using SFX_DVLD_Business.Licenses;
using System;
    ...
    public partial class frmListDetainedLicenses : Form
    {
        ...
        private void frmListDetainedLicenses_Load(object sender, EventArgs e)
        {
            ...
            if (dgvDetainedLicenses.Rows.Count > 0)
            {
                ...
                dgvDetainedLicenses.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDetainedLicenses.Columns[1].HeaderText = "L.ID";
                dgvDetainedLicenses.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDetainedLicenses.Columns[2].HeaderText = "D.Date";
                dgvDetainedLicenses.Columns[2].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                dgvDetainedLicenses.Columns[3].HeaderText = "Is Released";
                dgvDetainedLicenses.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDetainedLicenses.Columns[4].HeaderText = "Fine Fees";
                dgvDetainedLicenses.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDetainedLicenses.Columns[5].HeaderText = "Release Date";
                dgvDetainedLicenses.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                dgvDetainedLicenses.Columns[6].HeaderText = "N.No.";
                dgvDetainedLicenses.Columns[6].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
