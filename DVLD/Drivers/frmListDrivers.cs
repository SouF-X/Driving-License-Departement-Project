    ...
    public partial class frmListDrivers : Form
    {
        ...
        private void frmListDrivers_Load(object sender, EventArgs e)
        {
            ...
            if (dgvDrivers.Rows.Count > 0)
            {
                ...
                dgvDrivers.Columns[0].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDrivers.Columns[1].HeaderText = "Person ID";
                dgvDrivers.Columns[1].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;

                dgvDrivers.Columns[2].HeaderText = "National No.";
                dgvDrivers.Columns[2].Width = 110;

                dgvDrivers.Columns[3].HeaderText = "Full Name";
                dgvDrivers.Columns[3].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                dgvDrivers.Columns[4].HeaderText = "Date";
                dgvDrivers.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
