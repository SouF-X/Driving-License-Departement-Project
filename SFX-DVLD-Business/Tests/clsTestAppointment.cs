...
namespace SFX_DVLD_Business
{
    public class clsTestAppointment
    {
        ...
        public static clsTestAppointment Find(int TestAppointmentID)
        {
            ...
            if (clsTestAppointmentData.GetTestAppointmentInfoByID(TestAppointmentID, ref TestTypeID, ref LocalDrivingLicenseApplicationID, ref AppointmentDate, 
